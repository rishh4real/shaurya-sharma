      ...
      <section className="hero" aria-label="Shaurya Sharma portfolio home">
        ...
        <header className="topbar">
          ...
          <nav className="nav" aria-label="Primary navigation">
            ...
            <a href="/terms-and-conditions" className="nav-terms-link">
              Terms
            </a>
            <a
              href="#contact"
            ...
            {activeTab === "projects" && (
              ...
              >
                ...
                <div className="projects-grid">
                  ...
                  {/* Project Card 2: The Protein Drop */}
                  <motion.div
                    className="project-card"
                    whileHover={!isCompact ? { y: -8, scale: 1.015 } : undefined}
                    transition={{ duration: 0.3 }}
                  ...
                  {/* Project Card 4: NudgeHQ (Under Construction) */}
                  <motion.div
                    className="project-card"
                    whileHover={!isCompact ? { y: -8, scale: 1.015 } : undefined}
                    transition={{ duration: 0.3 }}
                  ...
                  {/* Project Card 7: LexFlow (Protected Portal) */}
                  <motion.div
                    className="project-card"
                    whileHover={!isCompact ? { y: -8, scale: 1.015 } : undefined}
                    transition={{ duration: 0.3 }}
